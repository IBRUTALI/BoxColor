package com.example.boxcolor.model.boxes
...
import com.example.boxcolor.model.sqlite.AppSQLiteContract
import com.example.boxcolor.model.sqlite.AppSQLiteContract.AccountsBoxesSettingsTable
import com.example.boxcolor.model.sqlite.AppSQLiteContract.BoxesTable
import com.example.boxcolor.model.sqlite.wrapSQLiteException
...
class SQLiteBoxesRepository(
    ...
    private suspend fun setActiveFlagForBox(box: Box, isActive: Boolean) {
        val account = accountsRepository.getAccount().firstOrNull() ?: throw AuthException()
